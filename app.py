...
from flask_frozen import Freezer  # Import the Freezer module
...
def reset():
    ...
    # Add a new route for generating static files
@app.route('/freeze')
def freeze():
    freezer.freeze()
    return 'Your app has been frozen into static files!'

if __name__ == "__main__":
    freezer = Freezer(app)  # Create a Freezer instance
    app.run(debug=True)